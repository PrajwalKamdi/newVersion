...
import { SiJavascript, SiReactquery, SiReactrouter, SiRedux, SiSpring, SiSpringboot } from "react-icons/si";
function Skills() {
  return (
    <main
          ...
          <div className="mt-5 px-5 md:px-10 hover:shadow-2xl hover:shadow-gray-700 duration-500 shadow-sm  py-14 rounded-xl   bg-[#121214] w-full flex gap-10 justify-between items-center">
            <div className="space-y-2">
              ...
              <p className="capitalize leading-6">
                Skilled in Java and Javascript, having more than 3+ years of experience in java and Javascript world
              </p>
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <ul className="text-lg md:flex flex-wrap md:flex-nowrap items-center">
                <li className="flex space-x-1 pr-1 items-center">
                  1. ReactJs<RiReactjsFill size={30} color="teal"/>
                </li>
                <li className="flex space-x-1 pr-2 items-center" >
                  2. React-Router <SiReactrouter size={30} color="teal" />
                </li>
                <li className="flex space-x-1 pr-2 items-center">
                  3. React-Query <SiReactquery size={30} color="teal" />
                </li>
                <li className="flex space-x-1 pr-2 items-center">
                  4. Redux-Toolkit<SiRedux size={30} color="teal" />
                </li>
              </ul>
              <p className="capitalize leading-6">
            ...
            <div className="space-y-2">
              ...
              <ul className="text-lg md:space-x-2 md:flex items-center">
                <li className="flex items-center space-x-2">
                  1. Spring <SiSpring size={25} color="green" />
                </li>
                <li className="flex items-center space-x-2">
                  2. Spring-Boot <SiSpringboot size={25} color="green" />
                </li>
              </ul>
